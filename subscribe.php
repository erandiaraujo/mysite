...
<?php
// STEP 11: Capture the value of the emailAddress INPUT from the index.php page by defining a PHP variable called, '$emailAddress': Below

// STEP 12: Set the above variable to equal $_GET['emailAddress'], and end the line with a semicolon (;): Below
...
// STEP 14: Test your index.php and the subscribe.php pages by using the form: it's working
// STEP 15: Check all your HTML and PHP code for formatting, and accuracy - then submit the URL to Lab 4 for credit: okAAF
